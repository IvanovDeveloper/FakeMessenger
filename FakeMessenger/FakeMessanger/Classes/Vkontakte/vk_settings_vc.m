...
#define k_Time_Label_Offset_output_X 39.f
#define k_Time_Label_Offset_input_X  5.f
#define k_Time_Label_Offset_Y  25.f
...
#define k_ImageView_Offset_Output_X 9.f
#define k_ImageView_Offset_Input_X  14.f
#define k_ImageView_OnlyImage_Offset_Y 8.f
#define k_ImageView_OnlyImage_Text_Offset_Y 10.f
...
#define k_Bubble_Type_Text_Offset_X 25.f
#define k_Bubble_Type_Text_Offset_W 25.f
#define k_Bubble_Type_Text_Offset_H 12.f

#define k_Bubble_Type_Image_Offset_X 24.f
#define k_Bubble_Type_Image_Offset_W 24.f
#define k_Bubble_Type_Image_Offset_H 17.f

#define k_Bubble_Type_Music_Offset_X 30.f
#define k_Bubble_Type_Music_Offset_W 30.f
#define k_Bubble_Type_Music_Offset_H 27.f

#define k_Bubble_Type_Text_Image_Offset_X 24.f
#define k_Bubble_Type_Text_Image_Offset_W 24.f
#define k_Bubble_Type_Text_Image_Offset_H 18.f

#define k_Bubble_Type_Text_Music_Offset_X 30.f
#define k_Bubble_Type_Text_Music_Offset_W 30.f
#define k_Bubble_Type_Text_Music_Offset_H 23.f

#define k_Bubble_Type_Image_Music_Offset_X 23.f
#define k_Bubble_Type_Image_Music_Offset_W 23.f
#define k_Bubble_Type_Image_Music_Offset_H 28.f

#define k_Bubble_Type_Text_Image_Music_Offset_X 23.f
#define k_Bubble_Type_Text_Image_Music_Offset_W 23.f
#define k_Bubble_Type_Text_Image_Music_Offset_H 31.f

@interface vk_settings_vc () < UITextViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIAlertViewDelegate, UITextFieldDelegate >
...
@property (nonatomic, strong) DB_vk *message;
...
#pragma mark Add Добавление значений полей в базу
    ...
    if ( [ self.message.bool_message_created boolValue ] == NO )
    {
        ...
        self.message = [ NSEntityDescription insertNewObjectForEntityForName:@"DB_vk" inManagedObjectContext:_context ];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        if ( indexPath.row == 3 )
        {
            cell = [ [ vk_settings_cell alloc ] initWithStyle:UITableViewCellStyleSubtitle
                                                 reuseIdentifier:CellIdentifier
                                                            type:cell_Music ];
        }
    }
...
-(CGSize)calculationSizePerformer
{
    ...
    textLabel.numberOfLines = 0;
    textLabel.opaque = NO;
    textLabel.font = [ UIFont fontWithName:@"Helvetica-Bold" size:k_Performer_Label_Offset_H ];
    [ textLabel sizeToFit ];
...
//if_Image_Music
        ...
        case bubble_Type_Image_Music:
        {
            ...
            {
                imageViewSize = CGRectMake(k_ImageView_Offset_Output_X,
                                           k_ImageView_OnlyImage_Offset_Y,
...
//if_Text_Image
        ...
        case bubble_Type_Text_Image:
        {
            ...
            if ( self.inputMassegeBool == 0 )
            {
                ...
                if ( imageSize.width > textSize.width )
                {
                    bubbleImageSize = CGRectMake((kScreenWidth - (imageSize.width + k_Bubble_Type_Text_Image_Offset_X)),
                                                 (k_Bubble_Offset_Y),
                                                 (imageSize.width                    + k_Bubble_Type_Text_Image_Offset_W ),
                                                 (imageSize.height + textSize.height + k_Bubble_Type_Text_Image_Offset_H));
                }
            }
            if ( self.inputMassegeBool == 1 )
